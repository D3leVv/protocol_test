...
import { useIsInsideMobileNavigation } from "components/Navigation/MobileNavigation"
import { useSectionStore } from "components/SectionProvider/SectionProvider"
...
function NavLink({
  ...
  return (
    ...
    >
      ...
      {tag && <TagButtonTemplate>{tag}</TagButtonTemplate>}
    </Link>
  )
}

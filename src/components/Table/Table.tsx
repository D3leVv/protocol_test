...
const TableFooter = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => (
    <tfoot ref={ref} className={cn("bg-foreground/10 text-body2/medium text-foreground", className)} {...props} />
  )
)
...
const TableHead = React.forwardRef<HTMLTableCellElement, React.ThHTMLAttributes<HTMLTableCellElement>>(
  ({ className, ...props }, ref) => <th ref={ref} className={cn(className, tdClass)} {...props} />
)
...
const TableCaption = React.forwardRef<HTMLTableCaptionElement, React.HTMLAttributes<HTMLTableCaptionElement>>(
  ({ className, ...props }, ref) => (
    <caption ref={ref} className={cn("mt-4 text-body2/regular text-foreground", className)} {...props} />
  )
)
...
const Table = Object.assign(
  ...
  >(({ className, paperClassName, scrollBarClassName, ...props }, ref) => (
    <Paper className={cn("items-start lg:p-6", paperClassName)}>
      ...
      >
        <table ref={ref} className={cn("table w-full min-w-full overflow-auto", className)} {...props}>
          {props.children}
        </table>
      </Scrollbar>
    </Paper>

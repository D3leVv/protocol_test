...
export function wrapper({ children }: { children: React.ReactNode }) {
  return (
    <article className="flex h-full flex-col pb-10 pt-16">
      ...
      <footer className="mx-auto mt-16 w-full max-w-2xl lg:max-w-5xl">{/* <Feedback /> */}</footer>
    </article>
  )
}
...
export const h2 = function H2({ children }: { children: React.ReactNode }) {
  return <h2 className="text-2xl font-semibold mt-12 mb-4">{children}</h2>
}
